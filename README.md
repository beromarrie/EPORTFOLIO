...
├── trainings.html               # Trainings & Seminars (Editorial Timeline with Integrated Certificates & Lightbox)
...
2. **Integrated Certificate Previews & Lightbox**:
   - Integrated directly into the **Trainings & Seminars** timeline entries.
   - Clicking any certificate thumbnail or "View Certificate" button triggers a modal with high-resolution view and direct download link.
...
4. **Structured Geodetic Skills Framework**:
   - Organized into real engineering disciplines (Surveying Operations, Survey Instruments, GIS and Mapping, CAD & Technical Drafting, Remote Sensing) without arbitrary percentage bars.
